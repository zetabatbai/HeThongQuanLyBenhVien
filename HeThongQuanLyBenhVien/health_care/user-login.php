	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../index.php"><h2> Hệ thống dịch vụ chăm sóc sức khỏe | Bệnh nhân đăng nhập</h2></a>
				</div>
				...
				<div class="box-login">
					...
					<div class="copyright">
						</span><span class="text-bold text-uppercase"> Hệ thống dịch vụ chăm sóc sức khỏe</span>.
					</div>
