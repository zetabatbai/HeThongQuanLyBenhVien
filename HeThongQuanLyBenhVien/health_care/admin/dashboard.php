				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Quản trị viên | Bảng điều khiển</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
...
$num_rows = mysqli_num_rows($result);//Trả về số lượng hàng trong tập kết quả.
{
?>
...
{
?>
Tổng bệnh nhân :<?php echo htmlentities($num_rows);  
} ?>		
</a>
											</p>
										</div>
...
?>
											Tổng truy vấn :<?php echo htmlentities($num_rows22);   ?>	
												</a>
												</a>
											</p>
										</div>
