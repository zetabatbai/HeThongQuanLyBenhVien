...
$_SESSION['msg']="Chuyên ngành bác sĩ cập nhật thành công !!";
} 
...
<html lang="en">
	<head>
		<title>Quản trị viên | Chỉnh sửa chuyên môn bác sĩ</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Quản trị viên | Chỉnh sửa chuyên môn bác sĩ</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
									...
									<li class="active">
										<span>Chỉnh sửa chuyên môn bác sĩ</span>
									</li>
								</ol>
							</div>
						</section>
										...
										<div class="col-lg-6 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Chỉnh sửa chuyên môn bác sĩ</h5>
												</div>
