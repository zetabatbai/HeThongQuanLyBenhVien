...
<input type="email" id="patemail" name="patemail" class="form-control"  placeholder="Nhập email của bệnh nhân" required="true" onBlur="userAvailability()">
...
<textarea type="text" name="medhis" class="form-control"  placeholder="Nhập tiền sử bệnh của bệnh nhân" required="true"></textarea>
</div>	
