...
<div class="row">
<div class="col-sm-8">
<h1 class="mainTitle">Bác sĩ | Thêm bệnh nhân</h1>
</div>
<ol class="breadcrumb">
<li>
<span>Bệnh nhân</span>
...
<textarea type="text" name="medhis" class="form-control"  placeholder="Nhập tiền sử bệnh nhân (nếu có) " required="true"><?php  echo $row['PatientMedhis'];?></textarea>
</div>	
<div class="form-group">
<label for="fess">
Ngày thành lập
