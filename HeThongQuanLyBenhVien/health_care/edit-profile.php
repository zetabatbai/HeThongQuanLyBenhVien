...
if($sql)
{
$msg="Thông tin của bạn được cập nhật thành công";
...
<html lang="en">
	<head>
		<title>Người dùng | Chỉnh sửa thông tin</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Người dùng | Chỉnh sửa thông tin</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Chỉnh sửa thông tin</h5>
												</div>
...
{
?>
<h4><?php echo htmlentities($data['fullName']);?>Hồ sơ của</h4>
<p><b>Hồ sơ đăng ký. Ngày: </b><?php echo htmlentities($data['regDate']);?></p>
<?php if($data['updationDate']){?>
<p><b>Profile Last Updation Date:Hồ sơ ngày cập nhật cuối cùng: </b><?php echo htmlentities($data['updationDate']);?></p>
<?php } ?>
